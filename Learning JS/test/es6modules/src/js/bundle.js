...
/***/ "./test/es6modules/src/js/main.js":
/*!****************************************!*\
  !*** ./test/es6modules/src/js/main.js ***!
  \****************************************/
...
/* harmony export */ });
let one = 1 // один вариант экспорта

let two = 2 

 // второй вариант экспорта

function sayHi() { // третий вариант экспорта
    console.log('Hello')
}

function sayBye() { // четвертый вариант экспорта
    console.log('Bye')
}
...
(() => {
/*!******************************************!*\
  !*** ./test/es6modules/src/js/script.js ***!
  \******************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _main_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./main.js */ "./test/es6modules/src/js/main.js");
